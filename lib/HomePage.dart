      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20,),
            Text('Account Over view',style: TextStyle(
              fontSize: 21,
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  avatarWidget('avatar1','Tom'),
                  avatarWidget('avatar2','Michael'),
                  avatarWidget('avatar3','Hannah'),
                ]
              )
            ),
            SizedBox(height: 20,),
            ...
            Expanded(
              child: GridView.count(crossAxisCount: 4,
                ...
                children: [
                  ...
                  serviceWidget('tag','Cashback\Offer'),
